...
body {{
    ...
    background: linear-gradient(135deg, #4fb8e6 0%, #6a9fe8 20%, #8b7de8 40%, #a06dd8 60%, #5ca3e8 80%, #4fb8e6 100%);
...
.stat-block.baseline {{ background: rgba(230,242,255,0.55); border: 1px solid rgba(26,115,232,0.15); -webkit-backdrop-filter: var(--blur); backdrop-filter: var(--blur); }}
.stat-block.ml {{ background: rgba(240,255,244,0.55); border: 1px solid rgba(52,168,83,0.15); -webkit-backdrop-filter: var(--blur); backdrop-filter: var(--blur); }}
            ...
            <div style="padding:0 20px 20px">
                ...
                <div style="margin-bottom:20px">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                        <div style="background:rgba(255,255,255,0.4);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,0.5);border-radius:14px;padding:14px 16px">
                ...
                <div style="margin-bottom:20px;overflow-wrap:break-word;word-break:break-word">
                    ...
                    <!-- Step 1 -->
                    <div style="background:rgba(255,255,255,0.4);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,0.5);border-radius:14px;padding:14px 16px;margin-bottom:8px">
